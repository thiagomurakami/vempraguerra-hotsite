...
const DefaultNews = (
  <>
    <li>
      ...
      >
        Estadão: Médicos do Hospital das Clínicas fazem campanha para arrecadar
        insumos para combate ao coronavírus (28/03/2020)
      </a>
    </li>
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        Istoé Dinheiro: Hospital das Clínicas faz campanha e busca arrecadar R$
        10 milhões (28/03/2020)
      </a>
    </li>
    <li>
      <a
    ...
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        Folha: Hospital das Clínicas arrecada R$ 1,2 mi para compra de máscaras
        e de álcool em gel (25/03/2020)
      </a>
    </li>
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        Catraca Livre: Médicos do HC se mobilizam para arrecadar R$ 10 mi par
    ...
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        UOL: Coronavírus: HC-SP prevê explosão de casos e quer arrecadar R$ 10
        milhões. (23/03/2020)
      </a>
    </li>
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        BORA SP - BAND: Hospital das Clínicas faz campanha de doações para
        compra de equipamentos (24/03/2020)
      </a>
    </li>
    <li>
      <a
        href="http://www.noticias.r7.com/saude/campanha-quer-arrecadar-r-10-mi-para-combate-ao-coronavirus-no-hc-24032020"
        target="_blank"
        rel="noopener noreferrer"
        style={{ textDecoration: 'none' }}
      >
        R7: Campanha quer arrecadar R$ 10 mi para combate ao coronavírus no HC
        (24/03/2020)
      </a>
    </li>
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        SBT: Hospital das Clínicas pede doações para combater o coronavírus |
        Primeiro Impacto (25/03/20)
      </a>
    </li>
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        GLOBO: Profissionais da saúde relatam falta de equipamentos de proteção
        (25/03/20)
      </a>
    </li>
  </>
...
const DefaultSupporters = (
  <>
    <li>
      <a
        href="https://www.corinthians.com.br/noticias/vempraguerra-corinthians-adere-a-campanha-para-compra-de-insumos-de-combate-ao-coronavirus"
        target="_blank"
        rel="noopener noreferrer"
        style={{ textDecoration: 'none' }}
      >
    ...
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        SPFC: ‘Vem pra Guerra’! São Paulo divulga campanha importante de doação
        para hospital
      </a>
    </li>
    <li>
    ...
    <li>
      <a
        ...
        style={{ textDecoration: 'none' }}
      >
        Reynaldo Gianecchini, Rodrigo Santoro, Ale Xavier, Nanda Costa e mais:
        Instagram
      </a>
    </li>
    <li>
...
const newsUrl =
  'https://docs.google.com/spreadsheets/u/1/d/1hxcCyz2bjWNPcIy06eOL-HGSOIMVHK_hKGPuKzuZp90/export?format=tsv&id=1hxcCyz2bjWNPcIy06eOL-HGSOIMVHK_hKGPuKzuZp90&gid=0'

const supportersUrl =
  'https://docs.google.com/spreadsheets/u/1/d/1hxcCyz2bjWNPcIy06eOL-HGSOIMVHK_hKGPuKzuZp90/export?format=tsv&id=1hxcCyz2bjWNPcIy06eOL-HGSOIMVHK_hKGPuKzuZp90&gid=77735724'

const News = () => {
  const [news, setNews] = React.useState()
  React.useEffect(() => {
    getDataFromSheets(newsUrl, setNews, data => {
      const transformedData = data.reduce((acc, [title, href, done]) => {
  ...
  React.useEffect(() => {
    getDataFromSheets(supportersUrl, setSupporters, data => {
      const transformedData = data.reduce((acc, [title, href, done]) => {
        if (done.indexOf('TRUE') !== -1) {
          acc.push({ title, href })
        }
    ...
    <section id="news">
      ...
      <ul style={{ listStyleType: 'none', marginLeft: 0, marginTop: '1rem' }}>
        {news
          ? news.map(({ title, href }) => {
              return (
                <LinkItem key={`${title}-${href}`} title={title} href={href} />
              )
            })
          : DefaultNews}
      </ul>
