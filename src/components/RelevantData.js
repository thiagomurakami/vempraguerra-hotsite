...
const RelevantData = () => (
  <section id="relevant-data">
    ...
    <p>
      ...
      acredita-se que cada pessoa possa contaminar de 2 a 3 outras. Há cerca de
      3 semanas, tivemos o primeiro caso confirmado e no dia 25 de março já são
      mais de 2400 casos e 50 mortes. Considerando a evolução da doença em
    ...
    <p>
      Tendo como pilares fundamentais Ensino, Pesquisa, e Assistência, o HC está
      na linha de frente na guerra contra o coronavírus. O hospital vem se
      mobilizando desde o início da disseminação do COVID-19, tendo organizado
      um Pronto-Atendimento somente para casos suspeitos, isolado do restante do
      hospital, aumentado sua capacidade de leitos de terapia intensiva e vem
      realizando treinamentos sistemáticos de seus funcionários. Além disso,
      suspendeu grande parte de seus atendimentos ambulatoriais para mobilizar a
      maior quantidade de pessoas para o atendimento dos doentes urgentes.
    </p>
    <p>
